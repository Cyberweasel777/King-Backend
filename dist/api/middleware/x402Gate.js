...
exports.buildX402UpgradePayload = buildX402UpgradePayload;
 ...
 */
function buildX402UpgradePayload(requestUrl, price = '$0.01') {
    if (!isX402Enabled())
        return null;
    ...
    return {
        ...
        body: {
            x402: {
                ...
                asset,
                payTo,
                description: 'This endpoint supports x402 pay-per-call. Send a payment header to bypass rate limits. See https://www.x402.org for client SDKs.',
                sdks: {
