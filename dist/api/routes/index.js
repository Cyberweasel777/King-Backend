...
const botindex_intel_1 = __importDefault(require("./botindex-intel"));
const botindex_compliance_1 = __importDefault(require("./botindex-compliance"));
...
router.use('/botindex', botindex_intel_1.default);
router.use('/botindex', botindex_compliance_1.default);
