...
router.get('/checkout', async (req, res) => {
    ...
    if (!(0, config_1.isStripeConfigured)(appId)) {
    ...
    const successUrl = (typeof req.query.successUrl === 'string' && req.query.successUrl) ||
    ...
    const cancelUrl = (typeof req.query.cancelUrl === 'string' && req.query.cancelUrl) ||
    ...
    if (!successUrl || !cancelUrl) {
        return res.status(500).json({
            ...
            message: 'Unable to determine success/cancel URLs. Provide ?successUrl=...&cancelUrl=... or set PAYMENTS_CHECKOUT_SUCCESS_URL / PAYMENTS_CHECKOUT_CANCEL_URL.',
        });
    }
    try {
...
//# sourceMappingURL=payments-global.js.map