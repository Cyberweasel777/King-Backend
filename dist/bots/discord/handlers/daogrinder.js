...
exports.createDAOGrinderBot = createDAOGrinderBot;
 ...
 * Discord: DAO Grinder
 */
function createDAOGrinderBot(client) {
    client.once(discord_js_1.Events.ClientReady, (readyClient) => {
        logger_1.logger.info(`[DAOGrinder] Discord bot ready as ${readyClient.user.tag}`);
    });
    client.on(discord_js_1.Events.MessageCreate, async (message) => {
        ...
        try {
            ...
            logger_1.logger.error('[DAOGrinder] Command error:', error);
        }
    });
    return client;
}
//# sourceMappingURL=daogrinder.js.map