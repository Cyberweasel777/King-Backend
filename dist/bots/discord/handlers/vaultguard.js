...
exports.createVaultGuardBot = createVaultGuardBot;
 ...
 * Discord: Vault Guard
 */
function createVaultGuardBot(client) {
    client.once(discord_js_1.Events.ClientReady, (readyClient) => {
        logger_1.logger.info(`[VaultGuard] Discord bot ready as ${readyClient.user.tag}`);
    });
    client.on(discord_js_1.Events.MessageCreate, async (message) => {
        ...
        try {
            ...
            logger_1.logger.error('[VaultGuard] Command error:', error);
        }
    });
    return client;
}
//# sourceMappingURL=vaultguard.js.map