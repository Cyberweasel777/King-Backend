...
function computeCreatorScore(marketCap, volume24h, holders, delta24h) {
...
async function getZoraCreatorScores(limit) {
    ...
    try {
        ...
        logger_1.default.info({ count: creators.length, topCreator: creators[0]?.handle }, 'Fetched live Zora creator scores');
