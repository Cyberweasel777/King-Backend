...
exports.skinportScraper = exports.SkinportScraper = void 0;
const base_scraper_1 = require("./base-scraper");
class SkinportScraper extends base_scraper_1.BaseScraper {
    constructor() {
        super({
            name: 'skinport',
    ...
    async scrape(skinName) {
        ...
        const errors = [];
        try {
            const items = await this.withRetry(() => this.request({
                method: 'GET',
                url: `${this.config.baseUrl}/items`,
                params: { app_id: 730, currency: 'USD', tradable: 1 },
                headers: this.getAuthHeaders(),
            }));
            const match = (items || []).find(i => i.market_hash_name.toLowerCase() === skinName.toLowerCase());
            if (match) {
...
exports.SkinportScraper = SkinportScraper;
exports.skinportScraper = new SkinportScraper();
//# sourceMappingURL=skinport-scraper.js.map