...
exports.addConstantProductBondingCurveBucketV2 = exports.addConstantProductBondingCurveBucketV2InstructionDiscriminator = exports.getAddConstantProductBondingCurveBucketV2InstructionDataSerializer = void 0;
...
function getAddConstantProductBondingCurveBucketV2InstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ...
        ['swapStartCondition', (0, types_1.getConditionSerializer)()],
        ['swapEndCondition', (0, types_1.getConditionSerializer)()],
    ...
    ], { description: 'AddConstantProductBondingCurveBucketV2InstructionData' }), (value) => ({
        ...value,
        discriminator: 64,
        bucketIndex: value.bucketIndex ?? 0,
        padding: value.padding ?? [0, 0, 0, 0, 0],
        backendSigner: value.backendSigner ?? (0, umi_1.none)(),
        actionsAuthority: value.actionsAuthority ?? (0, umi_1.none)(),
        reserved: value.reserved ?? [0, 0, 0, 0],
        endBehaviors: value.endBehaviors ?? [],
    }));
}
exports.getAddConstantProductBondingCurveBucketV2InstructionDataSerializer = getAddConstantProductBondingCurveBucketV2InstructionDataSerializer;
// Instruction discriminator.
exports.addConstantProductBondingCurveBucketV2InstructionDiscriminator = 64;
// Instruction.
function addConstantProductBondingCurveBucketV2(context, input) {
    // Program ID.
    ...
    if (!resolvedAccounts.bucket.value) {
        resolvedAccounts.bucket.value = (0, accounts_1.findBondingCurveBucketV2Pda)(context, {
    ...
    // Data.
    const data = getAddConstantProductBondingCurveBucketV2InstructionDataSerializer().serialize(resolvedArgs);
...
exports.addConstantProductBondingCurveBucketV2 = addConstantProductBondingCurveBucketV2;
//# sourceMappingURL=addConstantProductBondingCurveBucketV2.js.map