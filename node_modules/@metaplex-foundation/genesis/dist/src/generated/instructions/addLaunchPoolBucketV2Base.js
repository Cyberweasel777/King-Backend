...
exports.addLaunchPoolBucketV2Base = exports.addLaunchPoolBucketV2BaseInstructionDiscriminator = exports.getAddLaunchPoolBucketV2BaseInstructionDataSerializer = void 0;
...
function getAddLaunchPoolBucketV2BaseInstructionDataSerializer() {
    ...
    ], { description: 'AddLaunchPoolBucketV2BaseInstructionData' }), (value) => ({
        ...value,
        discriminator: 72,
...
exports.getAddLaunchPoolBucketV2BaseInstructionDataSerializer = getAddLaunchPoolBucketV2BaseInstructionDataSerializer;
// Instruction discriminator.
exports.addLaunchPoolBucketV2BaseInstructionDiscriminator = 72;
// Instruction.
function addLaunchPoolBucketV2Base(context, input) {
    // Program ID.
    ...
    if (!resolvedAccounts.bucket.value) {
        resolvedAccounts.bucket.value = (0, accounts_1.findLaunchPoolBucketV2Pda)(context, {
    ...
    // Data.
    const data = getAddLaunchPoolBucketV2BaseInstructionDataSerializer().serialize(resolvedArgs);
...
exports.addLaunchPoolBucketV2Base = addLaunchPoolBucketV2Base;
//# sourceMappingURL=addLaunchPoolBucketV2Base.js.map