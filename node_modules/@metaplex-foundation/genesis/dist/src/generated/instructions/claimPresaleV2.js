...
exports.claimPresaleV2 = exports.claimPresaleV2InstructionDiscriminator = exports.getClaimPresaleV2InstructionDataSerializer = void 0;
const mpl_toolbox_1 = require("@metaplex-foundation/mpl-toolbox");
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const accounts_1 = require("../accounts");
const shared_1 = require("../shared");
function getClaimPresaleV2InstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ['discriminator', (0, serializers_1.u8)()],
        ['padding', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 7 })],
    ], { description: 'ClaimPresaleV2InstructionData' }), (value) => ({
        ...value,
        discriminator: 52,
        padding: value.padding ?? [0, 0, 0, 0, 0, 0, 0],
    }));
}
exports.getClaimPresaleV2InstructionDataSerializer = getClaimPresaleV2InstructionDataSerializer;
// Instruction discriminator.
exports.claimPresaleV2InstructionDiscriminator = 52;
// Instruction.
function claimPresaleV2(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getClaimPresaleV2InstructionDataSerializer().serialize(resolvedArgs);
...
exports.claimPresaleV2 = claimPresaleV2;
//# sourceMappingURL=claimPresaleV2.js.map