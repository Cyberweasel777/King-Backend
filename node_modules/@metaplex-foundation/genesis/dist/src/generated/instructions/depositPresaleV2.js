...
exports.depositPresaleV2 = exports.depositPresaleV2InstructionDiscriminator = exports.getDepositPresaleV2InstructionDataSerializer = void 0;
const mpl_toolbox_1 = require("@metaplex-foundation/mpl-toolbox");
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const accounts_1 = require("../accounts");
const shared_1 = require("../shared");
function getDepositPresaleV2InstructionDataSerializer() {
    ...
    ], { description: 'DepositPresaleV2InstructionData' }), (value) => ({
        ...value,
        discriminator: 51,
        padding: value.padding ?? [0, 0, 0, 0, 0, 0, 0],
    }));
}
exports.getDepositPresaleV2InstructionDataSerializer = getDepositPresaleV2InstructionDataSerializer;
// Instruction discriminator.
exports.depositPresaleV2InstructionDiscriminator = 51;
// Instruction.
function depositPresaleV2(context, input) {
    // Program ID.
    ...
    if (!resolvedAccounts.depositPda.value) {
        if (resolvedAccounts.recipient.value) {
            resolvedAccounts.depositPda.value = (0, accounts_1.findPresaleDepositV2Pda)(context, {
    ...
    // Data.
    const data = getDepositPresaleV2InstructionDataSerializer().serialize(resolvedArgs);
    // Bytes Created On Chain.
    const bytesCreatedOnChain = (0, accounts_1.getPresaleDepositV2Size)() + umi_1.ACCOUNT_HEADER_SIZE;
    return (0, umi_1.transactionBuilder)([
        { instruction: { keys, programId, data }, signers, bytesCreatedOnChain },
    ]);
}
exports.depositPresaleV2 = depositPresaleV2;
//# sourceMappingURL=depositPresaleV2.js.map