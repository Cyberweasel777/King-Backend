...
exports.depositVaultV2 = exports.depositVaultV2InstructionDiscriminator = exports.getDepositVaultV2InstructionDataSerializer = void 0;
const mpl_toolbox_1 = require("@metaplex-foundation/mpl-toolbox");
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const accounts_1 = require("../accounts");
const shared_1 = require("../shared");
function getDepositVaultV2InstructionDataSerializer() {
...
exports.getDepositVaultV2InstructionDataSerializer = getDepositVaultV2InstructionDataSerializer;
// Instruction discriminator.
exports.depositVaultV2InstructionDiscriminator = 60;
// Instruction.
function depositVaultV2(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getDepositVaultV2InstructionDataSerializer().serialize(resolvedArgs);
    // Bytes Created On Chain.
    const bytesCreatedOnChain = (0, accounts_1.getVaultDepositV2Size)() + umi_1.ACCOUNT_HEADER_SIZE;
    return (0, umi_1.transactionBuilder)([
        { instruction: { keys, programId, data }, signers, bytesCreatedOnChain },
    ]);
}
exports.depositVaultV2 = depositVaultV2;
//# sourceMappingURL=depositVaultV2.js.map