...
exports.updateBondingCurveBucketV2 = exports.updateBondingCurveBucketV2InstructionDiscriminator = exports.getUpdateBondingCurveBucketV2InstructionDataSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
const types_1 = require("../types");
function getUpdateBondingCurveBucketV2InstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ...
        [
            'baseTokenAllocation',
            (() => {
                const inner = (0, serializers_1.u64)();
        ...
        [
            'swapStartCondition',
            (() => {
                const inner = (0, types_1.getConditionSerializer)();
                const sentinel = new Uint8Array([
    ...
    ], { description: 'UpdateBondingCurveBucketV2InstructionData' }), (value) => ({ ...value, discriminator: 91 }));
}
exports.getUpdateBondingCurveBucketV2InstructionDataSerializer = getUpdateBondingCurveBucketV2InstructionDataSerializer;
// Instruction discriminator.
exports.updateBondingCurveBucketV2InstructionDiscriminator = 91;
// Instruction.
function updateBondingCurveBucketV2(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getUpdateBondingCurveBucketV2InstructionDataSerializer().serialize(resolvedArgs);
...
exports.updateBondingCurveBucketV2 = updateBondingCurveBucketV2;
//# sourceMappingURL=updateBondingCurveBucketV2.js.map