...
exports.withdrawLaunchPoolV2 = exports.withdrawLaunchPoolV2InstructionDiscriminator = exports.getWithdrawLaunchPoolV2InstructionDataSerializer = void 0;
const mpl_toolbox_1 = require("@metaplex-foundation/mpl-toolbox");
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const accounts_1 = require("../accounts");
const shared_1 = require("../shared");
function getWithdrawLaunchPoolV2InstructionDataSerializer() {
    ...
    ], { description: 'WithdrawLaunchPoolV2InstructionData' }), (value) => ({
        ...value,
        discriminator: 69,
        padding: value.padding ?? [0, 0, 0, 0, 0, 0, 0],
    }));
}
exports.getWithdrawLaunchPoolV2InstructionDataSerializer = getWithdrawLaunchPoolV2InstructionDataSerializer;
// Instruction discriminator.
exports.withdrawLaunchPoolV2InstructionDiscriminator = 69;
// Instruction.
function withdrawLaunchPoolV2(context, input) {
    // Program ID.
    ...
    if (!resolvedAccounts.withdrawerBaseTokenAccount.value) {
        if (resolvedAccounts.withdrawer.value) {
            resolvedAccounts.withdrawerBaseTokenAccount.value =
    ...
    // Data.
    const data = getWithdrawLaunchPoolV2InstructionDataSerializer().serialize(resolvedArgs);
...
exports.withdrawLaunchPoolV2 = withdrawLaunchPoolV2;
//# sourceMappingURL=withdrawLaunchPoolV2.js.map