...
export declare function behavior(kind: 'BaseTokenRollover', data: GetDataEnumKindContent<BehaviorArgs, 'BaseTokenRollover'>): GetDataEnumKind<BehaviorArgs, 'BaseTokenRollover'>;
...
export declare function behavior(kind: 'ReallocateBaseTokensOnFailure', data: GetDataEnumKindContent<BehaviorArgs, 'ReallocateBaseTokensOnFailure'>): GetDataEnumKind<BehaviorArgs, 'ReallocateBaseTokensOnFailure'>;
