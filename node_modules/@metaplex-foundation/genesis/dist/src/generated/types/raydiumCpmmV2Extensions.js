...
exports.getRaydiumCpmmV2ExtensionsSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const _1 = require(".");
function getRaydiumCpmmV2ExtensionsSerializer() {
    return (0, serializers_1.struct)([
        ['reserved', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 8 })],
        [
            'backendSigner',
            (() => {
                const inner = (0, _1.getBackendSignerSerializer)();
        ...
        [
            'lpLockSchedule',
            (() => {
                const inner = (0, _1.getClaimScheduleSerializer)();
                const sentinel = new Uint8Array([
        ...
        ['padding', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 128 })],
    ], { description: 'RaydiumCpmmV2Extensions' });
}
exports.getRaydiumCpmmV2ExtensionsSerializer = getRaydiumCpmmV2ExtensionsSerializer;
//# sourceMappingURL=raydiumCpmmV2Extensions.js.map