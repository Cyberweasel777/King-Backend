...
exports.getTriggeredConditionSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const _1 = require(".");
function getTriggeredConditionSerializer() {
    return (0, serializers_1.struct)([
        ['conditionType', (0, _1.getConditionTypesSerializer)()],
        ['padding', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 55 })],
        [
            'triggeredTimestamp',
            (() => {
                const inner = (0, serializers_1.i64)();
    ...
    ], { description: 'TriggeredCondition' });
}
exports.getTriggeredConditionSerializer = getTriggeredConditionSerializer;
//# sourceMappingURL=triggeredCondition.js.map